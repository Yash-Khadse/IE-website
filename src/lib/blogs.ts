...
export const BLOGS: BlogPost[] = [
  ...
  },
  {
      ...
      excerpt: "Why relying solely on Next.js abstractions might be limiting your scalability when handling 10k+ concurrent connections.",
      date: "2024-03-05",
  ...
  {
      id: 5,
      title: "Edge Function Patters for Multi-Tenant SaaS",
      excerpt: "Implementing tenant isolation and low-latency personalization using middleware and edge compute.",
      date: "2024-02-01",
