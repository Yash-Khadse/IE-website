export const ourStoryContent = {
  badge: "Growth & Systems Studio",
  title: {
    line1: "From Scattered",
    highlight: "To Scaled."
  },
  paragraphs: [
  ...
  highlightLabel: "future of your business.",
  statsCard: {
    statusLabel: "Growth Status",
    activeLabel: "Scale Strategy Active",
    growthValue: "4.8x",
    growthDesc: "Avg. Growth Mult.",
    graphData: [40, 65, 45, 80, 55, 90, 70, 100]
  },
  testimonial: {
    stars: 5,
    text: "We finally found an agency that speaks data, not fluff.",
    author: "Michael K.",
