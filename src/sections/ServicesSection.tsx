          ...
          <motion.div style={{ y: y2 }} className="flex flex-col gap-4 col-span-1">
             ...
             >
                ...
                <div className="flex-1 relative border-l border-border ml-3 pl-6 flex flex-col justify-between py-2">
                    {['Acquisition', 'Activation', 'Retention'].map((step, i) => (
             ...
             >
                 <div>
                    <h3 className="text-muted-foreground text-xs uppercase tracking-widest mb-1">Revenue Lift</h3>
                    <div className="text-4xl font-bold text-foreground tracking-tighter group-hover:text-primary transition-colors">+142%</div>
                 </div>
             ...
             >
                ...
                <div className="relative w-32 h-32 flex items-center justify-center mt-2 group-hover:scale-105 transition-transform duration-500">
                   ...
                   <div className="absolute flex flex-col items-center">
                       <span className="text-3xl font-bold text-foreground">12<span className="text-sm text-muted-foreground">ms</span></span>
                   </div>
                </div>
             </motion.div>
             ...
             >
                 ...
                 <div className="flex-1 bg-secondary/50 border border-border rounded-xl p-3 relative z-10 backdrop-blur-md">
                    ...
                    <div className="flex items-center gap-2 mb-2">
                        ...
                        <div className="h-1 bg-primary rounded-full w-[70%]" />
                    </div>
                    <div className="flex items-center gap-2">
                        <CheckCircle2 size={12} className="text-green-500" />
                        <div className="h-1 bg-green-500 rounded-full w-[40%]" />
                    </div>
                 </div>
                 {/* Glow element */}
