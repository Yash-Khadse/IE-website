...
// --- THREE.JS VISUALS ---
// A flowing stream of data points representing "Knowledge Flow"
function KnowledgeStream(props: any) {
  ...
  // Generate particles spiraling outwards
  ...
  return (
    <group ref={groupRef} {...props}>
      {/* Central Core: The "Brain" or "Server" */}
      ...
      <Points ref={particlesRef} positions={particlePositions} stride={3} frustumCulled={false}>
         <PointMaterial 
            transparent 
            color="#5210F8" // Changed to Brand Purple (Intelligence)
            size={0.06} 
        ...
        <div ref={textRef} className="absolute inset-0 z-10 flex flex-col items-center justify-center pointer-events-none px-6">
            ...
            <div className="hidden md:grid grid-cols-3 gap-12 mt-16 max-w-4xl w-full text-center border-t border-white/5 pt-8 animate-in fade-in slide-in-from-bottom-6 duration-1000 delay-700">
                ...
                <div className="group flex flex-col items-center gap-2 cursor-pointer">
                    ...
                    <span className="text-xs font-mono font-bold text-white/60 tracking-widest uppercase group-hover:text-white transition-colors">Scale</span>
                </div>
                <div className="group flex flex-col items-center gap-2 cursor-pointer">
                    <Zap className="text-white/40 group-hover:text-[#C47DFD] transition-colors w-6 h-6" />
                    <span className="text-xs font-mono font-bold text-white/60 tracking-widest uppercase group-hover:text-white transition-colors">Performance</span>
                </div>
            </div>
        </div>
