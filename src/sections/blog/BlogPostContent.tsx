...
export default function BlogPostContent({ post }: { post: any }) {
  return (
    <article className="relative bg-background min-h-screen">
      ...
      <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 px-6 py-20 lg:py-32">
        ...
        <main className="lg:col-span-8 lg:col-start-4 prose prose-lg prose-invert max-w-none prose-headings:font-bold prose-headings:tracking-tight prose-p:text-muted-foreground prose-a:text-primary prose-a:no-underline hover:prose-a:underline prose-img:rounded-3xl prose-pre:bg-secondary/50 prose-pre:border prose-pre:border-border">
            
            <p className="lead text-xl md:text-2xl text-foreground font-medium mb-12 border-l-4 border-primary pl-6 py-2">
               {post.excerpt}
            </p>
            ...
            <div className="bg-[#020617] p-6 rounded-2xl border border-white/10 my-8 shadow-2xl overflow-x-auto">
