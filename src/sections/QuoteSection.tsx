...
const QuoteSection = () => {
  ...
  return (
    <section
      ref={containerRef}
      className="relative w-full py-20 md:py-48 bg-background min-h-[70vh] md:min-h-[90vh] flex items-center justify-center overflow-hidden border-t border-border"
    >
      ...
      <div className="relative z-10 w-full px-4 flex justify-center max-w-[1100px]">
        <CometCard className="w-full">
            ...
            className="w-full bg-card/50 backdrop-blur-xl border border-border rounded-[2.5rem] p-8 md:p-16 relative overflow-hidden group"
          >
            ...
            <div className="relative z-10 flex flex-col md:items-center md:text-center">
                ...
                <div className="flex items-center gap-2 px-4 py-2 rounded-full border border-primary/30 bg-primary/10 text-primary text-xs font-mono tracking-widest mb-10 w-fit mx-auto shadow-[0_0_15px_-3px_rgba(82,16,248,0.3)]">
                    ...
                    <span>INCOMING_TRANSMISSION_04</span>
                    <VoiceVisualizer />
                </div>
